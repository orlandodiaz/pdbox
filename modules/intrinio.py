...
class Intrinio(object):
    def __init__(self):
        self.username = '5125a193faf60ef5df93a9e0b0897d7b'
        self.password = '82b9e088c62765383fa01df32f8abf36'
        #self.url =  'https://api.intrinio.com/securities/search?conditions=marketcap~lt~200000000&page_size=500'
        self.url = 'https://api.intrinio.com/securities/search?conditions=marketcap~gt~250000000,marketcap~lt~10000000000'
        # &page_size=500'
